...
INNER JOIN film_actor AS fa2 ON fa1.film_id = fa2.film_id AND fa1.actor_id < fa2.actor_id  -- Junta con film_actor como fa2 usando identificadores de película y actor
INNER JOIN actor AS actor1 ON fa1.actor_id = actor1.actor_id  -- Junta con actor como actor1 usando identificadores de actor
INNER JOIN actor AS actor2 ON fa2.actor_id = actor2.actor_id  -- Junta con actor como actor2 usando identificadores de actor
